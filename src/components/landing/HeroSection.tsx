        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-center">
          ...
          <div className="flex flex-1 flex-col gap-6">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base font-normal leading-relaxed text-[#9dabb9] sm:text-lg max-w-[500px]">
                TradeMate는 충동적인 매매를 차단하고 당신의 원칙 준수를 평가합니다. 손익이 아닌 원칙 준수를 점수화하는 트레이딩 훈련 플랫폼을 지향합니다.
              </p>
            </div>
          ...
          <div className="w-full flex-1 md:w-auto">
            <div
              ...
              style={{
                backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCr1xaKYCeUJzSTE8ffvZ2ZuopfHEvOREfA2bBt_NLwC2VuJE37PcArjnz6FtMqbuif4DsxzFBk4yJQAJ8TYUMsy2tIasqAhnZRnmtNbvdgokQZpyL4JgCxbUWQDtOD6rrmVVLFBM8wgz9TvSuIgrYamURzGa-2QbVs1SK7Nzq90ra0wFPiUF6wKDl9N-gXRaeHzTYv246XbggeyOQjRHcn_qseZyRgd0nmxBirx0iVHFPidCHrId6lBr9EOkVrq9VRAoJNnAnXaT3k')",
